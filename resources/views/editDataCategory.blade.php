          ...
          $('#formakun').submit(function(e){
             e.preventDefault();
                swal({
                        ...
                        $.ajax({
                            url: "{{route('admin.storeEditCategory')}}",
                            type: 'GET',
                            ...
                            success: function(){                
                                setTimeout(function(){
                                  swal({
                                    ...
                                    window.location.href = "{{route('admin.tambahCatProduct')}}";
                                     ...
                                     <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($dataAmbil as $angs)
                                                    <input class="form-control" type="text" name="category_name" value="{{$angs->category_name}}"size="25" maxlength="20" >
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
