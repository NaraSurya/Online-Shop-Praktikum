          ...
          $('#formakun').submit(function(e){
             e.preventDefault();
                swal({
                        ...
                        $.ajax({
                            url: "{{route('admin.storeEditCourier')}}",
                            type: 'GET',
                            ...
                            success: function(){                
                                setTimeout(function(){
                                  swal({
                                    ...
                                    window.location.href = "{{route('admin.dataCourier')}}";
                                     ...
                                     <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="Courier" size="25" value="{{$cat}}"maxlength="20" >
                                                </div>
                                            </div>
                                        </div>
