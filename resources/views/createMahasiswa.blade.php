                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                @endif
                                    ...
                                    <form action="{{ route('admin.Storetambah') }}"method="post" enctype="multipart/form-data">
                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>umur </label>
                                                    <input class="form-control" id="price" type="text" name="umur" placeholder="umur" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>nim</label>
                                                    <input class="form-control" id="discount" type="text" name="nim" placeholder="nim" >
                                                </div>
                                            </div>
                                        <div class="col-lg-6">
                                         <div class="form-group">
